...
@param object options: {
  ...
  array|boolean vendors:
    array: seperated them from output built file to be in a single bundle file,
    true: use dependencies as vendors,
    false or null: ignore (do not contain) all externals packages, ignore means without vendors bundle,
    undefined or an empty array []: compile all styles in a file (when use [], no style will be extract to bundle file)
